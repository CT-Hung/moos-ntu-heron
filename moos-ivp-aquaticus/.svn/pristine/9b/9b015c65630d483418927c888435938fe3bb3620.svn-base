...
BHV_AvdColregsV23::BHV_AvdColregsV23(IvPDomain gdomain) : 
...
bool BHV_AvdColregsV23::setParam(string param, string value) 
{
...
void BHV_AvdColregsV23::onHelmStart()
{
...
void BHV_AvdColregsV23::onIdleState() 
{
...
void BHV_AvdColregsV23::onCompleteState() 
{
...
bool BHV_AvdColregsV23::onRunStatePrior() 
{
  return(true);
...
IvPFunction *BHV_AvdColregsV23::onRunState() 
{
  cout << "In BHV_AvdColregsV23::onRunState()" << endl; 
  m_iterations++;
...
string BHV_AvdColregsV23::getInfo(string param)
{
  string result;
...
double BHV_AvdColregsV23::getDoubleInfo(string param)
{
  double result = 0;
...
void BHV_AvdColregsV23::updateAvoidMode()
{
...
void BHV_AvdColregsV23::checkModeOvertaking()
{
  //=====================================================================  
...
IvPFunction* BHV_AvdColregsV23::buildOvertakingIPF()
{
...
void BHV_AvdColregsV23::checkModeHeadOn()
{
  //=====================================================================  
  // Part 1: Sanity checks, and absolute release check based on range
  //=====================================================================  
...
IvPFunction* BHV_AvdColregsV23::buildHeadOnIPF()
{
  // If ownship is already within the min_util_cpa_dist then we shrink
  // this distance, othewise the resulting ivp function will be universally
  // negative, resulting a function with no preference in any direction.
...
void BHV_AvdColregsV23::checkModeGiveWay()
{
  //=====================================================================  
  // Part 1: Sanity checks, and absolute release check based on range
  //=====================================================================  
...
IvPFunction* BHV_AvdColregsV23::buildGiveWayIPF()
{
  // If ownship is already within the min_util_cpa_dist then we shrink
  // this distance, othewise the resulting ivp function will be universally
  // negative, resulting a function with no preference in any direction.
...
void BHV_AvdColregsV23::checkModeStandOn()
{
  //=====================================================================  
  // Part 1: Sanity checks, and absolute release check based on range
  //=====================================================================  
...
void BHV_AvdColregsV23::checkModeStandOnOT()
{
  //=====================================================================  
  // Part 1: Sanity checks, and absolute release check based on range
  //=====================================================================  
...
void BHV_AvdColregsV23::checkModeCPA()
{
...
IvPFunction* BHV_AvdColregsV23::buildStandOnIPF()
{
...
IvPFunction* BHV_AvdColregsV23::buildCPA_IPF()
{
  // If ownship is already within the min_util_cpa_dist then we shrink
  // this distance, othewise the resulting ivp function will be universally
  // negative, resulting a function with no preference in any direction.
...
double BHV_AvdColregsV23::getRelevance() const
{
...
bool BHV_AvdColregsV23::resetAvoidModes(string mode, string submode)
{
  bool valid = true;
...
bool BHV_AvdColregsV23::findDecelerateSpeedRange(double& minv, double& maxv)
{
...
bool BHV_AvdColregsV23::findAccelerateSpeedRange(double& minv, double& maxv)
{
  // Part 0: initialize the results
  minv = 0;
  maxv = 0;
...
void BHV_AvdColregsV23::addHeading(double heading, double currtime)
{
...
void BHV_AvdColregsV23::addRelBng(double rel_bng, double currtime)
{
...
void BHV_AvdColregsV23::clearHeadings()
{
...
void BHV_AvdColregsV23::clearRelBngs()
{
...
bool BHV_AvdColregsV23::getHeadingRate(double& result, double min_secs)
{
  result = 0;
...
bool BHV_AvdColregsV23::getRelBngRate(double& result)
{
  result = 0;
...
void BHV_AvdColregsV23::postStatusInfo()
{
