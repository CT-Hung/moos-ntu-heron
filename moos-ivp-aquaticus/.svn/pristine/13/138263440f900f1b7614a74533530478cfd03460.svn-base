...
class TagManager : public AppCastingMOOSApp
{
 ...
 protected: // Processing Utilities
  ...
  bool    updateCanTagState(std::string vname);
  void    postTagSummary();
 ...
 protected: // State variables
  ...
  std::map<std::string, double>       m_map_node_vtags_next_tag;
  ...
  double        m_time_last_tagstats_post;
  
  std::string   m_prev_tagged_vnames;
  std::string   m_prev_cantag_summary;
