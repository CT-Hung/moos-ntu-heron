...
#--------------------------------------------------------------
#  Part 3B: If Heron hardware, set key info based on IP address
#--------------------------------------------------------------
if [ "${XMODE}" = "M300" ]; then
