...
/*    DATE: Feb 15th, 2022 (V23 from V19                         */
/*                                                               */
...
#ifndef BHV_AVD_COLREGS_V23_HEADER
#define BHV_AVD_COLREGS_V23_HEADER
...
class IvPDomain;
class BHV_AvdColregsV23 : public IvPContactBehavior {
 public:
  BHV_AvdColregsV23(IvPDomain);
  ~BHV_AvdColregsV23() {};
...
#ifdef WIN32
   // Windows needs to expl specify functions to export from a dll
...
extern "C" {
  IVP_EXPORT_FUNCTION IvPBehavior * createBehavior(std::string name,
						   IvPDomain domain) 
  {return new BHV_AvdColregsV23(domain);}
}
