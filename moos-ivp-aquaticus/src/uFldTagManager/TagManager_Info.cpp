...
void showInterfaceAndExit()
{
  ...
  blk("                                                                ");
  blk("  OZONE_TAGS = true/false  (if false, no tags for outside field)");
  ...
  blk("  CANTAG_SUMMARY      = deb=13567219699.1, abe=13567219705.4    ");
  blk("                                                                ");
...
void showReleaseInfoAndExit()
{
  ...
  cout << "Sep1623: Added posting of tag cooldown status" << endl;
  exit(0);
}
